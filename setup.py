...
setup(
    ...
    author="Jarred Osborne",
    author_email="J379038@tafe.wa.edu.au",
    description="A refactored version of a Tic Tac Toe game for AT1",
    license="MIT",
    keywords="tic-tac-toe refactoring",
    url="https://github.com/NM-TAFE/modularity-and-2d-data-structures-tumbleboy",  # project home page
)
